      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10 pb-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <a href="#partner" className="hover:underline">Partner with Us</a>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/calculators/sip-fv" className="hover:underline">SIP Calculator</Link></li>
            <li><Link to="/calculators/lumpsum-fv" className="hover:underline">Lumpsum Calculator</Link></li>
            <li><Link to="/calculators/sip-goal" className="hover:underline">Goal Calculator</Link></li>
            <li><Link to="/calculators/retirement" className="hover:underline">Retirement Calculator</Link></li>
            <li><Link to="/calculators/emi" className="hover:underline">EMI Calculator</Link></li>
          </ul>
        </div>
