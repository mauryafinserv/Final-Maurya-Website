...
const COMMISSION_DATA = [
  ...
  { amc: "Bandhan Mutual Fund", equity: "0.09% to 1.31%", debt: "0.05% to 0.85%", elss: "0.93%" },
  ...
  { amc: "HSBC Mutual Fund", equity: "0.13% to 1.27%", debt: "0.07% to 0.85%", elss: "1.10%" },
  { amc: "ICICI Prudential Mutual Fund", equity: "0.04% to 1.10%", debt: "0.04% to 0.51%", elss: "0.64%" },
  { amc: "Invesco Mutual Fund", equity: "0.21% to 1.36%", debt: "0.03% to 0.72%", elss: "1.02%" },
  { amc: "Kotak Mahindra Mutual Fund", equity: "0.15% to 1.25%", debt: "0.08% to 0.82%", elss: "0.91%" },
  ...
  { amc: "Motilal Oswal Mutual Fund", equity: "0.07% to 1.30%", debt: "0.15% to 0.80%", elss: "0.86%" },
  ...
  { amc: "PPFAS Mutual Fund", equity: "0.30% to 1.00%", debt: "0.08%", elss: "1.00%" },
  { amc: "SBI Mutual Fund", equity: "0.17% to 1.20%", debt: "0.04% to 0.76%", elss: "0.79%" },
  { amc: "Sundaram Mutual Fund", equity: "0.47% to 1.14%", debt: "0.08% to 1.06%", elss: "1.14%" },
  { amc: "Tata Mutual Fund", equity: "0.25% to 1.30%", debt: "0.05% to 0.75%", elss: "1.00%" },
  { amc: "UTI Mutual Fund", equity: "0.10% to 1.45%", debt: "0.05% to 1.00%", elss: "1.15%" },
];
